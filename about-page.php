        ...
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="about-img position-relative overflow-hidden p-5 pe-0">
                    <!-- Use get_template_directory_uri() to dynamically load the image -->
                    <img class="img-fluid w-100" src="<?php echo get_template_directory_uri(); ?>/img/about.jpg" alt="About Image">
                </div>
            </div>
